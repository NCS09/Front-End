...
export default function LoanDetailPage() {
    ...
    return (
        <div className="p-6 bg-gradient-to-b from-blue-50 to-white min-h-screen">
            <h1 className="text-3xl font-bold mb-6 text-center text-blue-600">รอการยืนยัน</h1>
            <div className="mb-6">
                <nav>
                                            ...
                                            <tr key={detail.loan_id} className="hover:bg-gray-50">
                                                ...
                                                <td className="py-4 px-4 whitespace-nowrap text-right text-sm font-medium">
                                                    ...
                                                    <button 
                                                        ...
                                                        className={`text-green-600 hover:text-green-900 mr-2 ${confirmingTransactionId === detail.transaction_id ? 'opacity-50 cursor-not-allowed' : ''}`}
                                                    ...
                                                    <button 
                                                        ...
                                                        className={`text-red-600 hover:text-red-900 ${confirmingTransactionId === detail.transaction_id ? 'opacity-50 cursor-not-allowed' : ''}`}
                                                        disabled={confirmingTransactionId === detail.transaction_id}
                                                    >
                                                        <X className="w-5 h-5" />
                                                    </button>
